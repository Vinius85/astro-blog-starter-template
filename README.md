...
Você pode jogar a versão HTML acessando `/game/` no site publicado. A interface inclui mapa clicável de províncias, ledger, mercado, estates, decretos provinciais, tecnologia, diplomacia e guerra.
